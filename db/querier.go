...
type Querier interface {
	...
	GetCRAMCredential(ctx context.Context, username string) (SmtpCramCredential, error)
	...
	InsertCRAMCredential(ctx context.Context, arg InsertCRAMCredentialParams) error
	// deliveries
	...
	ListCRAMCredentials(ctx context.Context) ([]SmtpCramCredential, error)
